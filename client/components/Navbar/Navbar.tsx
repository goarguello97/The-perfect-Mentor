  ...
  return width < 1440 ? (
    ...
    <div className={styles.navbar}>
      ...
      <div className={styles.menu}>
        ...
        <div>
          <Link href="/stadistics">
            <Image src={frame5} alt="frame5" className={styles.iconMenu} />
          </Link>
          <p>Stadistics</p>
        </div>
        <div>
          <Link href="/reports">
            <Image src={frame6} alt="frame6" className={styles.iconMenu}  />
          </Link>
          <p>Reports</p>
        </div>
        <div>
          <Link href="/profile">
            <Image src={frame7} alt="frame7" className={styles.iconMenu}  />
          </Link>
          <p>Profile</p>
        </div>
      </div>
